...
- [Choosing models](./model-choice.md): Pick a channel and model by budget and role
...
- [ACP Agent Mode](./acp.md): Serve the Agent Client Protocol so ACP clients can drive Chord
