...
| 文件                                                           | 适用场景                                                                                       |
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| [`anthropic-minimal.yaml`](./anthropic-minimal.yaml)           | 最小可用——一个 provider、一个 key、一个模型池                                              |
...
| [`team-ready.yaml`](./team-ready.yaml)                         | 严格按 agent 权限、用 hooks 做审计/lint、配 `.chord/` 项目级覆盖                              |
