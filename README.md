...
Source builds require Go 1.27.0 or newer. With the default `GOTOOLCHAIN=auto`, Go downloads the required toolchain automatically when needed.

If you do not have Go 1.27.0+, download a prebuilt binary from [GitHub Releases](https://github.com/keakon/chord/releases). Pick the archive for your OS/architecture, extract it, put `chord` on your `PATH`, and run:
