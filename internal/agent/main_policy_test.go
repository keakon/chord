...
func TestStartPlanExecutionResetsTrackedReadState(t *testing.T) {
	...
	if err := ensureTrackedApplyPatchPreconditions(a.fileTrack, a.instanceID, stalePath, tools.NameApplyPatch); err == nil || !strings.Contains(err.Error(), "has not been read") {
