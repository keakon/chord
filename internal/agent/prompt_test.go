...
func TestShouldEnableBugTriagePrompt_KeywordForms(t *testing.T) {
	...
	issueForms := []formCase{
		...
		{"fail", "analyze why the tests fail"},
		{"fails", "analyze why the test fails"},
		{"failed", "analyze why the build failed"},
		{"failing", "analyze the failing test"},
		...
		{"not working", "analyze why the feature is not working"},
		{"stopped working", "analyze why it stopped working"},
