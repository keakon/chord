...
func (m *Model) infoPanelFingerprint(width, height int) string {
	...
	b.WriteString(m.pendingPoolSwitch.from)
	appendSep()
	b.WriteString(m.pendingPoolSwitch.to)
	appendSep()
	...
	appendSep()
	appendFloat6(threshold)
	appendSep()
	appendInt(contextBytes)
	appendSep()
	appendInt(msgCount)
	appendSep()
	appendInt(reduction.Messages)
	appendSep()
	appendInt(reduction.Bytes)
	appendSep()
	appendInt(reduction.CurrentBytes)
	appendSep()
	appendInt(reduction.CurrentMessages)
	appendSep()
	appendInt(reduction.TokensSaved)
	appendSep()
	appendBool(reduction.Protected)
	appendSep()
	appendBool(reduction.ReusedStable)
	appendSep()
